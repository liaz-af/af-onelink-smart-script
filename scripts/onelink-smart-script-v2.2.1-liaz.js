/**
 * AF Smart Script (Build 2.2.1-liaz)
 */
...
(function () {
  var generateOneLinkURL = function generateOneLinkURL() {
    ...
    window.AF_SMART_SCRIPT.displayQrCode = function (htmlId) {
      var qrProp = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      var _qrProp$logo = qrProp.logo,
          logo = _qrProp$logo === void 0 ? '' : _qrProp$logo,
          _qrProp$bgColor = qrProp.bgColor,
          bgColor = _qrProp$bgColor === void 0 ? '#000' : _qrProp$bgColor;
